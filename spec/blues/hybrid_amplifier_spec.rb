...
module Blues
  RSpec.describe HybridAmplifier do
    describe "#turn_on" do
      it "sets the amplifier on when it is off" do
        amp = HybridAmplifier.new
    ...
    describe "#volume" do
      it "is the specified volume when the warm up time is complete" do
        amp = HybridAmplifier.new(volume: 10)
      ...
      it "is less than the specified volume directly before the amp is warmed up" do
        amp = HybridAmplifier.new(volume: 9)
    ...
    describe "#pre_amp_tone" do
      ...
      it "has a warm tone at a low volume" do
        amp = HybridAmplifier.new(volume: 1)
        amp.turn_on
        warm_up
      ...
      it "has a warm tone at a mid volume" do
        amp = HybridAmplifier.new(volume: 6)
        amp.turn_on
        warm_up
      ...
      it "has a hot tone at a high volume" do
        amp = HybridAmplifier.new(volume: 8)
        amp.turn_on
        warm_up
