...
module Blues
  RSpec.describe Amp do
    describe "#turn_on" do
      it "sets the amplifier on when it is off" do
        amp = Amp.new(volume: 10, pre_amp: TubePreAmplifier.new, power_amp: TubePowerAmplifier.new)
    ...
    describe "#volume" do
      ...
      it "is less than the specified volume directly before the amp is warmed up" do
        amp = Amp.new(volume: 9, pre_amp: TubePreAmplifier.new, power_amp: TubePowerAmplifier.new)
    ...
    describe "#pre_amp_tone" do
      ...
      it "has a warm tone at a low volume" do
        amp = Amp.new(volume: 1, pre_amp: TubePreAmplifier.new, power_amp: TubePowerAmplifier.new)
        amp.turn_on
        warm_up
      ...
      it "has a warm tone at a mid volume" do
        amp = Amp.new(volume: 6, pre_amp: TubePreAmplifier.new, power_amp: TubePowerAmplifier.new)
        amp.turn_on
        warm_up
      ...
      it "has a hot tone at a high volume" do
        amp = Amp.new(volume: 8, pre_amp: TubePreAmplifier.new, power_amp: TubePowerAmplifier.new)
        amp.turn_on
        warm_up
    ...
    describe "#pre_amp_weight" do
      it "is heavy" do
        amp = Amp.new(pre_amp: TubePreAmplifier.new, power_amp: TubePowerAmplifier.new)
